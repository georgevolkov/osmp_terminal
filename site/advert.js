    ...
    null,
    {
        ...
        setAdvertPlaceList: function() {
            ...
            switch (this.pageName) {
                ...
                case 'SportLoto_Rules':
                    result.push('main_adv');
                    break;

                case 'SportLoto_Account':
                    result.push('main_adv');
                    break;
        ...
        getAdvContent: function(contentArr, isFirstPlace) {
            ...
            switch (contentType) {
                case 'text':
                    html =
                        '<textarea style="overflow:hidden; border-style:none; width:100%; height:100%; font-size:17pt; color:#a61d00; background-color: #e6e6e6; font-family:Arial; font-weight:bold;">' +
                            content +
                        '</textarea>';
                ...
                default:
                    /*if (isFirstPlace) {
                        html =
                            ...
                            '               <param name="quality" value="best" />' +
                            '               <param name="wmode" value="transparent" />' +
			    '               <embed width=100% height=100% src="./img/swf/banner.swf"></embed> ' +
                            '           </object>' +
	                        '       </td>' +
	                        '   </tr>' +
	                        '</table>';
