...
function putParams() {
    ...
    cook.setCookie("sf_alert", "Вам необходимо в обязательном порядке обратиться в районный/городской Социальный фонд для получения страхового полюса.<br>Адрес районного/городского управления СФКР указан в чеке!", false);
    //На указанный Вами личный страховой счет будет зачислена сумма страхового взноса.<br><br>О состоянии личного страхового счета можете узнать на сайте: www.socfond.kg
}