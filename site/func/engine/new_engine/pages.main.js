...
(
	CPage,
	{
	    ...
	    _getData: function() {
	        ...
	        this._aTopElements = UITopElements;
	    ...
	    _createContent: function(sPlace) {
	        ...
	        else
	        {
	        	var splace = $(sPlace);
			splace.vAlign = "top";
			splace.innerHTML = [ '<div id="', this._sInstance, '_top_elements"></div><div id="', this._sInstance, '_groups_holder"></div>' ].join('');

			this._drawTopElements(this._sInstance + "_top_elements");
	    ...
	    _preLoadTopElements: function() {
	    	...
	    	{
		    	getScript('./config/' + this._aTopElements[i] + '.js', this._preCreateTopElements, [i], this);
	    	}
	    	else
	    	{
	    ...
	    _createBottomMenu: function(sPlace) {		
	        ...
	        this._oRightBtmBtn = new CBtmMenuButton(this, "right_btn", "btn_right", "search_anim.gif", "search_press.gif");
	        ...
	        //this._oLeftBtmBtn.setEnabled(false);
	    },
	    ...
	    _createTopElements: function() {
			...
			if(oPlace)
			{
					...
					var oElement = new CTopElementButton(this, 
						...
						getFileName(el.elementValue.small_logo));
	    ...
	    _loadGroup: function(prvId, group, hash){
	        if(!group) group = {};
	        getScript('./config/' + prvId + '.js', function(){
