...
function processTranslate(sLang) {
    ...
    getTextById("button_forward_loto", sLocale);
...
function processProvider(sNumber) { 
    ...
    var sTxt = getText("cellular_successful_notice_loto", sLocale);    
    var sNoPrv = getText("cellular_unsuccessful_notice", sLocale);
    var sBadFormat = getText("cellular_bad_format_loto", sLocale);
    var prov = null;            
