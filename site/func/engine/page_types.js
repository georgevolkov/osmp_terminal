...
function rayon(type) {
    switch (type) {
        case "01":
            return addFolder("001_gnsRayon", "Октябрьский р-н")
                + addFolder("002_gnsRayon", "Ленинский р-н")
                + addFolder("003_gnsRayon", "Свердловский р-н")
                + addFolder("004_gnsRayon", "Первомайский р-н");
        case "02":
            return addFolder("005_gnsRayon", "Аламудунский р-н")
                + addFolder("007_gnsRayon", "Кеминский р-н")
                + addFolder("008_gnsRayon", "Иссык-Атинский р-н")
                + addFolder("009_gnsRayon", "Жайылский р-н")
                + addFolder("010_gnsRayon", "Московский р-н")
                + addFolder("011_gnsRayon", "Панфиловский р-н")
                + addFolder("012_gnsRayon", "Сокулукский р-н")
                + addFolder("013_gnsRayon", "Чуйский р-н")
                + addFolder("058_gnsRayon", "г. Чуй-Токмок");
        case "03":
            return addFolder("014_gnsRayon", "Иссык-Кульский р-н")
                + addFolder("015_gnsRayon", "Ак-Суйский р-н")
                + addFolder("016_gnsRayon", "Тонский р-н")
                + addFolder("017_gnsRayon", "Жети-Огузский р-н")
                + addFolder("018_gnsRayon", "Тюпский р-н")
                + addFolder("019_gnsRayon", "г.Каракол")
                + addFolder("020_gnsRayon", "г.Балыкчы");
        case "04":
            return addFolder("021_gnsRayon", "Алайский р-н")
                + addFolder("022_gnsRayon", "Чон-Алайский р-н")
                + addFolder("023_gnsRayon", "Араванский р-н")
                + addFolder("025_gnsRayon", "Кара-Сууйский р-н")
                + addFolder("027_gnsRayon", "Ноокатский р-н")
                + addFolder("028_gnsRayon", "Кара-Кульджинский р-н")
                + addFolder("029_gnsRayon", "Узгенский р-н");
        case "05":
            return addFolder("034_gnsRayon", "Ак-Талинский р-н")
                + addFolder("035_gnsRayon", "Ат-Башинский р-н")
                + addFolder("036_gnsRayon", "Кочкорский р-н")
                + addFolder("037_gnsRayon", "Жумгальский р-н")
                + addFolder("038_gnsRayon", "Нарынский р-н")
                + addFolder("059_gnsRayon", "г. Нарын");
        case "06":
            return addFolder("039_gnsRayon", "Сузакский р-н")
                + addFolder("040_gnsRayon", "Ноокенский р-н")
                + addFolder("041_gnsRayon", "Ала-Букинский р-н")
                + addFolder("042_gnsRayon", "Токтогульский р-н")
                + addFolder("043_gnsRayon", "Аксыйский р-н")
                + addFolder("044_gnsRayon", "Тогуз-Тороузский р-н")
                + addFolder("045_gnsRayon", "Базар-Курганский р-н")
                + addFolder("047_gnsRayon", "Чаткальский р-н")
        ...
        case "07":
            return addFolder("053_gnsRayon", "Таласский р-н")
                + addFolder("054_gnsRayon", "Бакай-Атинский р-н")
                + addFolder("055_gnsRayon", "Кара-Буринский р-н")
                + addFolder("056_gnsRayon", "Манасский р-н")
                + addFolder("057_gnsRayon", "г.Талас");
        case "08":
            return addFolder("024_gnsRayon", "Баткенский р-н")
                + addFolder("026_gnsRayon", "Ляйлякский р-н")
                + addFolder("030_gnsRayon", "Кадамжайский р-н")
...
function finish() {
    ...
    if (sPrvId == "11144") sForward = "./anykey_keyboard_gns.html";
